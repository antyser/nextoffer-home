...
export const metadata = {
  title: 'Terms of Service - NextOffer',
  description: 'Terms of Service for NextOffer AI Interview Assistant',
};
    ...
    <>
      ...
      <main className="flex-grow">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 md:py-24">
          <h1 className="text-4xl font-bold mb-8 text-gray-100">Terms of Service</h1>
          ...
          <div className="space-y-6 text-indigo-200/65">
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">4. Use of Services</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">5. Suspension and Termination of Access to the Services</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">6. Intellectual Property</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">7. Subscriptions</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">8. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">9. Indemnity</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>your violation of these Terms, and/or</li>
              <li>your violation of any right(s) of any third party.</li>
            </ul>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">10. Early Stage Service</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">11. Dispute Resolution</h2>

            <h3 className="text-xl font-semibold text-gray-300 mt-6">a. Governing Law and Jurisdiction</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-300 mt-6">d. Waiver of Jury Trial</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-300 mt-6">e. Confidentiality of Arbitration</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-300 mt-6">f. Section 11</h3>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
            <li>hereby irrevocably and unconditionally submit to the jurisdiction of the courts of the State of Delaware for such purpose;</li>
            <li>agrees not to commence any suit, action or other proceeding arising in connection with or based upon this instrument or the matters contemplated by this instrument except before the courts of the State of Delaware;</li>
            <li>hereby waives, and agrees not to assert, by way of motion, as a defense, or otherwise, in any such suit, action or proceeding, any claim that it is not subject personally to the jurisdiction of the above-named courts, that its property is exempt or immune from attachment or execution, that the suit, action or proceeding is brought in an inconvenient forum, that the venue of the suit, action or proceeding is improper or that this instrument or the subject matter hereof or thereof may not be enforced in or by such court.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-300 mt-6">g. No Class Actions Permitted</h3>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">12. External Links</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">13. Assignment</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">14. Severability</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">15. Entire Agreement</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-200 mt-8">16. Waivers</h2>
            <p>
